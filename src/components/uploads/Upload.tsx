                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="flex flex-col gap-1 text-sm">
                                <div className='flex items-center gap-2'><span className='font-semibold'>Status:</span> <Badge>Processed</Badge></div>
                                <div><span className='font-semibold'>Uploaded on:</span> 2021-10-10</div>
                                <div><span className='font-semibold'>Uploaded by:</span> Olga Shavochkina</div>
                            </div>
                        </CardContent>
                    </Card>
